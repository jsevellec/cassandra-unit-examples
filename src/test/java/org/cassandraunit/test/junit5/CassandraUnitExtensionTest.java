 ...
 *
 * <p>If Cassandra is <em>not</em> yours to start - a Testcontainers container, a shared node, a
 * managed service - use {@code CqlDataSetExtension} instead, which loads the same datasets
 * through a session you supply. See {@link CqlDataSetExtensionTest}.
 */
